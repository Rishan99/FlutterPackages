...
void main() {
  ...
  group('Tap gesture', () {
    ...
    test('notifies claiming listener registered first', () {
      ...
      _proxy.add(GestureListener(onTapTest: claimingTapDownListener.callback, onTap: claimingTapListener.callback));
      ...
      _proxy.add(GestureListener(onTapTest: nonclaimingTapDownListener.callback, onTap: nonclaimingTapListener.callback));
  ...
  group('LongPress gesture', () {
    test('notifies with tap', () {
      ...
      _proxy.add(GestureListener(onTapTest: tapDown.callback, onTap: tap.callback, onTapCancel: tapCancel.callback));
      ...
      _proxy.add(GestureListener(onTapTest: pressTapDown.callback, onLongPress: longPress.callback, onTapCancel: pressCancel.callback));
  ...
  group('Drag gesture', () {
    test('wins over tap', () {
      ...
      _proxy.add(GestureListener(onTapTest: dragTapDown.callback, onDragStart: dragStart.callback, onDragUpdate: dragUpdate.callback, onDragEnd: dragEnd.callback, onTapCancel: dragCancel.callback));
