...
void main() {
  ...
  setUp(() {
    ...
    final myFakeDesktopAData = [MyRow('MyCampaign1', 1, 1, 1), MyRow('MyCampaign2', 2, 2, 2), MyRow('MyCampaign3', 3, 3, 3)];

    final myFakeTabletAData = [MyRow('MyCampaign1', 2, 2, 2), MyRow('MyCampaign2', 3, 3, 3), MyRow('MyCampaign3', 4, 4, 4)];

    final myFakeMobileAData = [MyRow('MyCampaign1', 3, 3, 3), MyRow('MyCampaign2', 4, 4, 4), MyRow('MyCampaign3', 5, 5, 5)];

    final myFakeDesktopBData = [MyRow('MyCampaign1', 10, 8, 12), MyRow('MyCampaign2', 20, 18, 22), MyRow('MyCampaign3', 30, 28, 32)];

    final myFakeTabletBData = [MyRow('MyCampaign1', 20, 18, 22), MyRow('MyCampaign2', 30, 28, 32), MyRow('MyCampaign3', 40, 38, 42)];

    final myFakeMobileBData = [MyRow('MyCampaign1', 30, 28, 32), MyRow('MyCampaign2', 40, 38, 42), MyRow('MyCampaign3', 50, 48, 52)];
