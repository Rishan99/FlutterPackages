...
void main() {
  ...
  setUp(() {
    ...
    _series2 = MutableSeries(
      Series<MyRow, int>(id: 's2', data: [_s2D1, _s2D2, _s2D3], domainFn: (MyRow row, _) => row.campaign, measureFn: (MyRow row, _) => row.count, colorFn: (_, __) => MaterialPalette.red.shadeDefault),
    )..measureFn = (_) => 0.0;
  });
  ...
  group('LinePointHighlighter', () {
    test('highlights the selected points', () {
      ...
      _setupSelection([SeriesDatum(_series1, _s1D2), SeriesDatum(_series2, _s2D2)]);
