...
void main() {
  ...
  group('Details', () {
    test('expands to domain and includes closest series', () {
      ...
      _makeBehavior(SelectionModelType.info, SelectionTrigger.hover, selectClosestSeries: true);
      Point<double> point = Point(100.0, 100.0);
      _setupChart(forPoint: point, isWithinRenderer: true, respondWithDetails: [_details1, _details1Series2], seriesList: [_series1, _series2]);
    ...
    test('adds overlapping points from same series if there are any', () {
      ...
      _setupChart(forPoint: point, isWithinRenderer: true, respondWithDetails: [details1, details2], seriesList: [series]);
