...
class FakeBarRenderer<D> extends BarRenderer<D> {
  ...
  FakeBarRenderer._internal({@required BarRendererConfig config, @required String rendererId}) : super.internal(config: config, rendererId: rendererId);
...
void main() {
  ...
  setUp(() {
    var myFakeDesktopAData = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', 25), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];

    var myFakeTabletAData = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', 25), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];

    var myFakeMobileAData = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', 25), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];

    var myFakeDesktopBData = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', 25), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];

    var myFakeTabletBData = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', 25), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];

    var myFakeMobileBData = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', 25), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];
  ...
  group('preprocess weight pattern', () {
    test('with grouped bars', () {
      renderer = makeRenderer(
        config: BarRendererConfig(groupingType: BarGroupingType.grouped, weightPattern: [3, 2, 1]),
      );
    ...
    test('with grouped stacked bars', () {
      renderer = makeRenderer(
        config: BarRendererConfig(groupingType: BarGroupingType.groupedStacked, weightPattern: [2, 1]),
      );
    ...
    test('with stacked bars - weightPattern not used', () {
      renderer = makeRenderer(
        config: BarRendererConfig(groupingType: BarGroupingType.stacked, weightPattern: [2, 1]),
      );
    ...
    test('with bar max width', () {
      ...
      final data = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', 0), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];
  ...
  group('null measure', () {
    test('only include null in draw if animating from a non null measure', () {
      ...
      final myDataWithNull = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', null), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];
      final seriesListWithNull = _createSeriesList(myDataWithNull);

      final myDataWithMeasures = [MyRow('MyCampaign1', 5), MyRow('MyCampaign2', 0), MyRow('MyCampaign3', 100), MyRow('MyOtherCampaign', 75)];
