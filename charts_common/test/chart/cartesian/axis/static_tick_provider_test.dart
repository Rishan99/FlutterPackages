...
void main() {
  ...
  group('scale is extended with static tick values', () {
    test('values extend existing domain values', () {
      final tickProvider = StaticTickProvider<num>([TickSpec<num>(50, label: '50'), TickSpec<num>(75, label: '75'), TickSpec<num>(100, label: '100')]);
  ...
  group('formatter', () {
    ...
    test('is called when one ticks does not have label', () {
      final tickProvider = StaticTickProvider<num>([TickSpec<num>(50, label: '50'), TickSpec<num>(75), TickSpec<num>(100, label: '100')]);
    ...
    test('is called when all ticks do not have labels', () {
      final tickProvider = StaticTickProvider<num>([TickSpec<num>(50), TickSpec<num>(75), TickSpec<num>(100)]);
