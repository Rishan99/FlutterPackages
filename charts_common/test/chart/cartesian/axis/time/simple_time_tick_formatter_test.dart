...
void main() {
  ...
  setUp(() {
    ...
    simpleTimeFormatterWithDateFormat = SimpleTimeTickFormatter(formatter: dateFormat.format);
  });

  group(SimpleTimeTickFormatter, () {
    test('formatter with custom formatting function input', () {
      final actualLabelFirstTick = simpleTimeFormatter.formatFirstTick(testDate1);
      final actualLabelSimpleTick = simpleTimeFormatter.formatSimpleTick(testDate1);
      final actualLabelTransitionTick = simpleTimeFormatter.formatTransitionTick(testDate1);
      final actualBoolIsTransition = simpleTimeFormatter.isTransition(testDate2, testDate1);
    ...
    test('formatter with DateFormat formatting function', () {
      ...
      final actualLabelFirstTick = simpleTimeFormatterWithDateFormat.formatFirstTick(testDate1);
      final actualLabelSimpleTick = simpleTimeFormatterWithDateFormat.formatSimpleTick(testDate1);
      final actualLabelTransitionTick = simpleTimeFormatterWithDateFormat.formatTransitionTick(testDate1);
      final actualBoolIsTransition = simpleTimeFormatterWithDateFormat.isTransition(testDate2, testDate1);
