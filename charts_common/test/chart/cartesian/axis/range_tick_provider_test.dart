  ...
  group('scale is extended with range tick values', () {
    test('values extend existing domain values', () {
      final tickProvider = RangeTickProvider<num>([
        ...
        RangeTickSpec<num>(20200531, label: 'Week 1', rangeStartValue: 20200531, rangeEndValue: 20200607),
        RangeTickSpec<num>(20200607, label: 'Week 2', rangeStartValue: 20200607, rangeEndValue: 20200614),
        RangeTickSpec<num>(20200614, label: 'Week 3', rangeStartValue: 20200614, rangeEndValue: 20200621),
      ]);
  ...
  group('formatter', () {
    ...
    test('is called when one ticks does not have label', () {
      final tickProvider = RangeTickProvider<num>([
        TickSpec<num>(20200601, label: '20200601'),
        TickSpec<num>(20200608, label: '20200608'),
        RangeTickSpec<num>(20200531, rangeStartValue: 20200531, rangeEndValue: 20200607),
        RangeTickSpec<num>(20200607, label: 'Week 2', rangeStartValue: 20200607, rangeEndValue: 20200614),
      ]);
    ...
    test('is called when all ticks do not have labels', () {
      final tickProvider = RangeTickProvider<num>([
        ...
        RangeTickSpec<num>(20200531, rangeStartValue: 20200531, rangeEndValue: 20200607),
        RangeTickSpec<num>(20200607, rangeStartValue: 20200607, rangeEndValue: 20200614),
      ]);
