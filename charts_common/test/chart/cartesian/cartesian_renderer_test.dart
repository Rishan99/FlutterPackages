...
class FakeCartesianRenderer extends BaseCartesianRenderer {
  ...
  @override
  List<DatumDetails> getNearestDatumDetailPerSeries(Point<double> chartPoint, bool byDomain, Rectangle<int> boundsOverride, {selectOverlappingPoints = false, selectExactEventLocation = false}) =>
      null;
