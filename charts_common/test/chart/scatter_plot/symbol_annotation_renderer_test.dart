...
class MyRow {
  ...
  final String shape;
  MyRow(this.campaignString, this.campaign, this.campaignLower, this.campaignUpper, this.radius, this.boundsRadius, this.shape);
}
...
void main() {
  ...
  group('preprocess', () {
    test('with numeric data and simple points', () {
      renderer = SymbolAnnotationRenderer<int>(config: SymbolAnnotationRendererConfig());
