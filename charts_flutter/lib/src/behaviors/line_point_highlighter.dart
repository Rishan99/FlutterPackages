...
class LinePointHighlighter<D> extends ChartBehavior<D> {
  ...
  @override
  int get hashCode {
    return Object.hash(selectionModelType, defaultRadiusPx, radiusPaddingPx, showHorizontalFollowLine, showVerticalFollowLine, dashPattern, drawFollowLinesAcrossChart);
  }
}
